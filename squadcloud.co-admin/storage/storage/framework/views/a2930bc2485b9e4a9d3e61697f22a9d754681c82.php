...
<html lang="en">
  <head>
    <title>Blink Broadband | Internet Service Provider</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<link rel="icon" href="<?php echo e(asset('site/favicon.png')); ?>" sizes="192x192" />
    ...
    <style>
        *{
        ...
        .slider
        {
            ...
            top: 0;
            left: 0;
            background-image: url(<?php echo e(URL::asset('site/img/Q2KBDFBujC_1608959945.jpg')); ?>);
  ...
  <body>
      ...
      <div class="counter-div d-flex flex-column justify-content-center">
          <p class="text-center"><img src="<?php echo e(asset('site/upload/logo-min.png')); ?>" class="img-fluid" width="250" alt=""></p>
        <div class="container">
    ...
    <script>
        ...
        var countDownDate = new Date("<?php echo e(date('M j, Y H:i:s', strtotime($maintenance->time))); ?>").getTime();
...
</html><?php /**PATH /www/wwwroot/blinkbroadband.pk/vendor/laravel/framework/src/Illuminate/Foundation/Exceptions/views/503.blade.php ENDPATH**/ ?>