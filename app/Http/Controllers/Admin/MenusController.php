...
class MenusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($hassubmenu) {
            ...
            foreach ($request->submenu as $key => $value) {
                $subMenuValidator = Validator::make(['submenu' => $value, 'submenuroute' => $request->submenuroute[$key]], ['submenu' => 'required', 'submenuroute' => 'required']);
    ...
    public function destroy($id)
    {
        DB::transaction(function () use ($id) {
            ...
            $userAccess = UserMenuAccess::whereIn(
                'sub_menu_id',
                SubMenu::where('menu_id', $menu->id)
                    ->select('id')
                    ->get()
                    ->toArray(),
            );
