        ...
        <div class="col-12">
          <div class="card mt-3 card-outline card-info">
            <div class="card-header">
              <h3 class="card-title"><span><i class="fa-solid fa-box-open"></i></span> Slideritems</h3>
              <a class="btn btn-success btn-sm float-right" href="{{route('slideritems.create')}}"><i class="fa fa-plus"></i> Add Slideritems</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr class="table-row"> 
                      ...
                      <td>
                        <img width="40px" height="40px" src="{{ asset('frontend_assets/images/slideritems/' . $item->image_1) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                    </td>
                      <td>
                        <img width="40px" height="40px" src="{{ asset('frontend_assets/images/slideritems/' . $item->image_2) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                    </td>
                      <td>
                        <img width="40px" height="40px" src="{{ asset('frontend_assets/images/slideritems/' . $item->image_3) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                    </td>
                      <td>
                        <img width="40px" height="40px" src="{{ asset('frontend_assets/images/slideritems/' . $item->image_4) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                    </td>
                      ...
                      <td class="d-flex justify-content-center" style="gap: 5px;">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('slideritems.edit', $item->id) }}"><i class="fa fa-edit"></i></a>
...
<script>
  let packageDeleteUrl  = "{{route('slideritem.destroy')}}"; 
      ...
      if (result.value) {
       $.ajax({
        ...
        success:function(res){
          if(res.unauthorized){
            swal('Error!' , 'No Rights To delete Slideritem' , "error");
          }
          if(res.status)
          {
           swal('Updated!', 'Slideritem deleted', 'success');
           location.reload();
