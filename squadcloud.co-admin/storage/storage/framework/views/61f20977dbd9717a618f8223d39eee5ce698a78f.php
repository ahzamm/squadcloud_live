        ...
        <div class="col-12">
          <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <div class="ml-auto">
                <a href="<?php echo e(route('popup.create')); ?>" class="btn btn-success btn-sm">
            ...
            <div class="card-body ">
              <div class="table-responsive ">
                <table class="table table-bordered table-striped" id="example">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $data['popup']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($loop->iteration); ?></td>
                      <td><img src="<?php echo e(asset('PopUpImages/'.$item->image )); ?>"  alt="" style="width: 50px; height:50px ; object-fit:cover"></td>
                      ...
                      <td>
                        <a href="<?php echo e(route('popup.edit'  , $item->id)); ?>" class="btn btn-primary btn-sm"><i class="fa fa-pen"></i></a>
...
<script>
  $(document).ready(function() {
    $('#example').DataTable();
    let changeStatusUrl  = "<?php echo e(route('popup.status')); ?>";
        // Changing Status
        ...
        // Delete Script
        let deleteUrl = "<?php echo e(route('popup.destroy')); ?>";
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/Popup/index.blade.php ENDPATH**/ ?>