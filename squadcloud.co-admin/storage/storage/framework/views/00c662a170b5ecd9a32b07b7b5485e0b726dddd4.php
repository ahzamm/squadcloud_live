    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-outline card-info mt-3">
          ...
          <form action="<?php echo e(route('whychoose.store')); ?>" method="POST" enctype="multipart/form-data">
            <!-- /.card-header -->
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Best Broadband Service In Pakistan" value="<?php echo e(old('title')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/WhyChooseUs/create.blade.php ENDPATH**/ ?>