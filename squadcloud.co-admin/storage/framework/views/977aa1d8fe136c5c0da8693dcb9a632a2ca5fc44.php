<div class="modal-header">
  ...
  <div class="modal-body">
    ...
    <form id="ipEditForm">
        ...
        <input type="hidden" name="id" value="<?php echo e($ip->id); ?>">

        <div class="form-group">

          <label for="exampleInputEmail1">Full Name <span style="color: red">*</span></label>

        <input type="text" name="person_name" value="<?php echo e($ip->person_name); ?>" class="form-control" placeholder="Example : Jawad Alam" required>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="<?php echo e($ip->ip_address); ?>" name="ip_address" placeholder="Example : 192.168.0.1" required>
  ...
  </div><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/allowedip/edit.blade.php ENDPATH**/ ?>