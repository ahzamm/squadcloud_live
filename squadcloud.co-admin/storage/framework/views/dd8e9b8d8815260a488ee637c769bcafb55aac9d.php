      ...
      <div class="col-md-12">
        <div class="card card-outline card-info mt-2">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0"><span><i class="fa-solid fa-comment-dots"></i></span> <?php echo e($parentTitle); ?> PoPup</h3>
            <div class="ml-auto">
              <a class="btn btn-outline-secondary btn-sm" href="<?php echo e(route('popup.index')); ?>">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="">Upload PopUp Image <span style="color: red">* <span style="color: lightgrey">(The file dimensions should be 500 pixels by 500 pixels.)</span></label>
...
<script>
  function validateImageSize(input) {
    if (input.files && input.files[0]) {
      ...
      <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/Popup/create.blade.php ENDPATH**/ ?>