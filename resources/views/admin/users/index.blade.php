                    ...
                    <tbody>
                      @foreach ($data['users'] as $item)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('user.menu.access', $item->id) }}" title="Give Access" class="btn btn-sm btn-info"><i class="fa fa-unlock"></i></a>
                            <a href="{{ route('user.edit', $item->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-pen"></i></a>
...
@push('scripts')
  ...
  <script>
    $(document).ready(function() {
      $('#example').DataTable();
      let changeStatusUrl = "{{ route('user.status.change') }}";
      // Changing Status
