                                ...
                                <div class="card" style="border-color: rgb(126, 120, 120);">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('frontmenu.store') }}" method="POST" id="AddMenusForm" enctype="multipart/form-data">
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="page_title" type="text" class="form-control"
                                                            placeholder="Example : Contact Us"  value="{{old('page_title')}}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <a class="btn btn-outline-secondary btn-sm float-right ml-2"
                                                        href="{{ route('frontmenu.index') }}">Cancel</a>
                                                    <button class="btn btn-outline-primary btn-sm float-right"
                                                        type="submit" id="menuBtn">Submit</button>
                                                </div>
                                            </div>
                                    </div>
                                    </form>
