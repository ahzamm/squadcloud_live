        ...
        <div class="col-md-12">
          <div class="card card-outline card-info mt-2">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title mb-0"><span><i class="fa fa-podcast"></i></span> Add Portfolio</h3>
              <div class="ml-auto">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="url" class="form-control" name="link" placeholder="Link" required value="{{ old('link') }}">
                      @error('color')
                        <p class="text-danger mt-2 mb-0 text-sm">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="route" placeholder="Route" required value="{{ old('route') }}">
                      @error('color')
                        <p class="text-danger mt-2 mb-0 text-sm">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="rating" placeholder="Rating" required value="{{ old('rating') }}">
                      @error('color')
                        <p class="text-danger mt-2 mb-0 text-sm">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="rating_number" placeholder="Rating Number" required value="{{ old('rating_number') }}">
                      @error('color')
                        <p class="text-danger mt-2 mb-0 text-sm">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="price" placeholder="Price" required value="{{ old('price') }}">
                      @error('color')
                        <p class="text-danger mt-2 mb-0 text-sm">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="price_description" placeholder="Price Description" required value="{{ old('price_description') }}">
                      @error('color')
                        <p class="text-danger mt-2 mb-0 text-sm">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      <label for=""> Product Image <span style="color: red">*</span></label> <br>
