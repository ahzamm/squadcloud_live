 ...
 *-->
 ...
 <div class="social">
  ...
  <a href="<?php echo e($link->url); ?>" target="_blank">
   <div class="social-btn" style="background-color: <?php echo e($link->color); ?>;">
     <p class="order-1 google-font margin-instagram"><?php echo e($link->name); ?></p>
     <div class="<?php echo e($link->icon); ?>" style="color: white; width: 30px; height: 30px;" ></div>
   </div>
 </a>
           ...
           <div class="col-lg-12">
             <div class="form-group">
               <select name="" id="province" class="form-control custom-form-input">
                 ...
                 <?php $__currentLoopData = $proviences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
   ...
   let startDate = '<?php echo e(optional($popUpdeals)->start_date); ?>'; // Highlighted
    let startTime = '<?php echo e(optional($popUpdeals)->start_time); ?>'; // Highlighted
    let endDate = '<?php echo e(optional($popUpdeals)->end_date); ?>'; // Highlighted
    let endTime = '<?php echo e(optional($popUpdeals)->end_time); ?>'; // Highlighted
   ...
   popupImage.src = imagePath;
     ...
     function updateTime() {
       ...
       if (currentDate >= startDateAndTime && currentDate < endDateAndTime) {
         ...
         let imageUrl = "<?php echo e(optional($popUpdeals)->image); ?>";
         setTimeout(function() {
 ...
 <?php echo $__env->make('site.partial.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
           ...
           <div id="home" data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_row-no-padding">
            ...
            <div class="video_wrapper">
              <video autoplay muted loop style="width:100%;height:100%">
                <source src="<?php echo e(asset('VideoHeader/' . $Videos->video)); ?>" type="video/mp4">
                </video>
              </div>
              <?php else: ?>
                 ...
                 <div class="wpb_wrapper">
                   <div class="wpb_revslider_element wpb_content_element">
                     <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-source="gallery" style="background: transparent; padding: 0px;">
                       <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.slides')->dom;
} elseif ($_instance->childHasBeenRendered('0UhAJ2U')) {
    $componentId = $_instance->getRenderedChildComponentId('0UhAJ2U');
    $componentTag = $_instance->getRenderedChildComponentTagName('0UhAJ2U');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0UhAJ2U');
} else {
    $response = \Livewire\Livewire::mount('front.slides');
    $dom = $response->dom;
    $_instance->logRenderedChild('0UhAJ2U', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                     </div>
           ...
           <!-- <div class="vc_row wpb_row vc_row-fluid">
                 ...
                 <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.pakage-detail')->dom;
} elseif ($_instance->childHasBeenRendered('ne7w8Sk')) {
    $componentId = $_instance->getRenderedChildComponentId('ne7w8Sk');
    $componentTag = $_instance->getRenderedChildComponentTagName('ne7w8Sk');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ne7w8Sk');
} else {
    $response = \Livewire\Livewire::mount('front.pakage-detail');
    $dom = $response->dom;
    $_instance->logRenderedChild('ne7w8Sk', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                     ...
                     <div class="vc_column-inner vc_custom_1501257004641">
                       <div class="wpb_wrapper">
                         ...
                         <div>
                           <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.reseller-detail')->dom;
} elseif ($_instance->childHasBeenRendered('NoTOcby')) {
    $componentId = $_instance->getRenderedChildComponentId('NoTOcby');
    $componentTag = $_instance->getRenderedChildComponentTagName('NoTOcby');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NoTOcby');
} else {
    $response = \Livewire\Livewire::mount('front.reseller-detail');
    $dom = $response->dom;
    $_instance->logRenderedChild('NoTOcby', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                         </div>
                 ...
                 <div id="about-us" class="vc_row wpb_row vc_row-fluid vc_custom_1501509753637 vc_row-o-equal-height vc_row-flex">
                   ...
                   <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.about')->dom;
} elseif ($_instance->childHasBeenRendered('kQejHgR')) {
    $componentId = $_instance->getRenderedChildComponentId('kQejHgR');
    $componentTag = $_instance->getRenderedChildComponentTagName('kQejHgR');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kQejHgR');
} else {
    $response = \Livewire\Livewire::mount('front.about');
    $dom = $response->dom;
    $_instance->logRenderedChild('kQejHgR', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                   <?php if($message[0]->active == 1): ?>
                   <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.messages')->dom;
} elseif ($_instance->childHasBeenRendered('MOBYp0q')) {
    $componentId = $_instance->getRenderedChildComponentId('MOBYp0q');
    $componentTag = $_instance->getRenderedChildComponentTagName('MOBYp0q');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MOBYp0q');
} else {
    $response = \Livewire\Livewire::mount('front.messages');
    $dom = $response->dom;
    $_instance->logRenderedChild('MOBYp0q', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                   <?php endif; ?>
                   ...
                   <div id="why-choose-us" data-vc-full-width="true" data-vc-full-width-init="false" data-vc-parallax="1.5" data-vc-parallax-image="" class="vc_row wpb_row vc_row-fluid vc_custom_1501511161351 vc_row-has-fill vc_general vc_parallax vc_parallax-content-moving">
                     ...
                     <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.why-us-details')->dom;
} elseif ($_instance->childHasBeenRendered('PUPdoLY')) {
    $componentId = $_instance->getRenderedChildComponentId('PUPdoLY');
    $componentTag = $_instance->getRenderedChildComponentTagName('PUPdoLY');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PUPdoLY');
} else {
    $response = \Livewire\Livewire::mount('front.why-us-details');
    $dom = $response->dom;
    $_instance->logRenderedChild('PUPdoLY', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                   </div>
                     ...
                     <div class="wpb_column vc_column_container vc_col-sm-8">
                       <div class="vc_column-inner">
                         <div class="wpb_wrapper">
                           ...
                           <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.contact')->dom;
} elseif ($_instance->childHasBeenRendered('xazl77S')) {
    $componentId = $_instance->getRenderedChildComponentId('xazl77S');
    $componentTag = $_instance->getRenderedChildComponentTagName('xazl77S');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xazl77S');
} else {
    $response = \Livewire\Livewire::mount('front.contact');
    $dom = $response->dom;
    $_instance->logRenderedChild('xazl77S', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                         </div>
                       ...
                       <div class="vc_column-inner vc_custom_1501257004641">
                         <div class="wpb_wrapper">
                           ...
                           <div>
                             <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('front.faqs')->dom;
} elseif ($_instance->childHasBeenRendered('W0hVBlT')) {
    $componentId = $_instance->getRenderedChildComponentId('W0hVBlT');
    $componentTag = $_instance->getRenderedChildComponentTagName('W0hVBlT');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('W0hVBlT');
} else {
    $response = \Livewire\Livewire::mount('front.faqs');
    $dom = $response->dom;
    $_instance->logRenderedChild('W0hVBlT', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                           </div>
           ...
           <div class="row custom__footer" style="padding: 10px 0px 0px 0px">
             <div class="col-md-12 col-sm-12">
               <p style="color: white; line-height: 1.8; margin-left: 20px; font-size: 16px; text-align:center">
                 &copy; 2012 Blink Broadband. Powered by <a target="_blank" class="powered-link" href="https://logon.com.pk" style="color: #FFF"><?php echo e($frontSettings->footer); ?></a>
               </p>
             </div>
 ...
 <!-- <div class="container-fluid footer-wrapper">
     ...
     <div class="offcanvas-sidebar sidebar">
       <ul id="offcanvas-sidebar" class="clearfix">
         ...
         <li id="text-10" class="widget widget_text">
           ...
           ?>
           <div class="textwidget">
             <p><span><i class="fa fa-location-dot" style="color: white;font-size: 15px;"></i> </span> <?php echo e($sideMenuHomeData->address); ?></p>
             <p>
               <span><i class="fa fa-phone-volume" style="color: white;font-size: 15px;"></i> </span> <?php echo e($sideMenuHomeData->phone); ?><br />
               <span><i class="fa fa-envelope" style="color: white;font-size: 15px;"></i> </span> <span class="text-color-theme"><a href="mailto:<?php echo e($sideMenuHomeData->email); ?>" class="__cf_email__"><?php echo e($sideMenuHomeData->email); ?></a></span>
             </p>
           </div>
         </li>
         <li id="barrel-social-icons-3" class="widget widget_barrel_social_icons">
           ...
           <div class="textwidget">
             <div class="social-icons-wrapper">
               ...
               ?>
               <ul>
                 <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <li>
                   <a style="color: white;font-size:30px" href="<?php echo e($social->url); ?>" target="_blank" onmouseover="changeColor(this, '<?php echo e($social->color); ?>')" onmouseout="changeColorBack(this)">
   ...
   <!-- Code Finalize -->
<?php echo $__env->make('site.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/site/home/index.blade.php ENDPATH**/ ?>