          ...
          <div class="card mt-3 card-outline card-info">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex align-items-center ml-auto"> <!-- Updated class here -->
                <a class="btn btn-success btn-sm ml-2" href="<?php echo e(route('cities.create')); ?>"> <!-- Moved Add City button after dropdown -->
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $province; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($item->province_id == $item2->id): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('cities.edit',$item->id)); ?>"><i class="fa fa-edit"></i></a>
                        <a class="btn btn-danger deleteRecord btn-sm text-white" data-value="<?php echo e($item->id); ?>"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php endif; ?>
...
<script>
  let deleteUrl = "<?php echo e(route('destroy.cities')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/cities/index.blade.php ENDPATH**/ ?>