                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="">User Name <span style="color: red">*</label>
                      <input type="text" class="form-control" id="username" name="user_name" placeholder="Example : Administrator"  value="{{old('user_name') == NULL?$user->name:old('user_name') }}">
                      @error('name')
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="">First Name <span style="color: red">*</label>
                        <input type="text" class="form-control" id="firstname" name="first_name" placeholder="Example : Jawad"  value="{{old('first_name') == NULL?$user->first_name:old('first_name') }}" >
                        @error('email')
                        <p class="text-danger  mb-0 text-sm">{{$message}}</p>
                        @enderror
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="">Last Name <span style="color: red">*</label>
                          <input type="text" class="form-control" id="lastname" name="last_name" placeholder="Example : Alam"   value="{{old('last_name') == NULL?$user->last_name:old('last_name') }}">
                          @error('email')
                          <p class="text-danger  mb-0 text-sm">{{$message}}</p>
                          @enderror
                        </div>
