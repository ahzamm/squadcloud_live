  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <p class="login-box-msg text-danger"><?php echo e(Session::get('message')); ?></p>
        <?php endif; ?>
...
<!-- Code Finalize --><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>