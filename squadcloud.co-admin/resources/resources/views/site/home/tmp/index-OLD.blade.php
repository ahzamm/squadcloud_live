 ...
 <div class="popup" id="captchaPopupPartner">
  ...
  <div class="captcha-box">
    <div class="captcha">
      ...
      <form id="captchaFormPartner">
        ...
        <button type="submit" id="captchaSubmitPartner">Submit</button></form>
        <p id="result"></p>
      </div>
    </div>
  </div>
  ...
  <div class="popup" id="captchaPopupUser">
    ...
    <div class="captcha-box">
      <div class="captcha">
        ...
        <form action="" id="captchaFormUser">
          ...
          <button type="submit" id="captchaSubmitUser">Submit</button></form>
          <p id="result"></p>
        </div>
      </div>
    </div>
    ...
    <!-- Social icons -->
    <div class="social">
      <a href="https://www.facebook.com/blink.broadband.2024" target="_blank">
      ...
      <a href="https://www.linkedin.com/company/blink-broadband/" target="_blank">
        <div class="social-btn color-linkedIn">
          <div class="icons8-linkedIn"></div>
          <p class="order-1 google-font margin-telgram">LinkedIn</p>
        </div>
      </a>
      <a href="tel:03111125465" target="_blank">
        <div class="social-btn color-whatsapp">
          <div class="icons8-whatsapp"></div>
          <p class="order-1 google-font margin-instagram">311 11 BLINK</p>
        </div>
      </a>
  <!-- <a href="#">
    <div class="social-btn color-whatsapp">
...
let startDate = '<?php echo(isset($popUpdeals->start_date)) ; ?>' ;
let startTime = '<?php echo(isset($popUpdeals->start_time));?>';
let endDate = '<?php echo(isset($popUpdeals->end_date)) ; ?>';
let endTime = '<?php echo(isset($popUpdeals->end_time)) ; ?> ';
...
function updateTime() {
  ...
  if (currentDate >= startDateAndTime && currentDate < endDateAndTime) {
    ...
    const delay = 3000;
    let baseUrl = "{{asset('')}}";
    let imageUrl = "<?php echo(isset($popUpdeals->image));?>";
         ...
         <div class="textwidget">
           <div class="social-icons-wrapper">
            ...
            <ul>
              @foreach($links as $social) 
              <li>
               <a style="color: white;font-size:30px" href="{{$social->url}}" target="_blank"
                onmouseover="changeColor(this, '{{$social->color}}')"
                onmouseout="changeColorBack(this)">
                <i class="{{$social->icon}}"></i>
              </a>
