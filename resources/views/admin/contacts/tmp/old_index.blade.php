        ...
        <div class="col-12">
          <div class="card mt-3 card-outline card-info">
            <div class="card-header">
              ...
              <a class="btn btn-success btn-sm float-right" href="{{route('contacts.create')}}"><i class="fa fa-plus"></i> Add Contacts</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr class="table-row"> 
                      ...
                      <td>{{$item->email}}</td>
                      <td>{{$item->address}} </td>
                      <td>{{$item->office_hours_start}}</td>
                      <td>{{$item->office_hours_end}}</td>
                      ...
                      <td class="d-flex justify-content-center" style="gap: 5px;">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('contacts.edit', $item->id) }}"><i class="fa fa-edit"></i></a>
