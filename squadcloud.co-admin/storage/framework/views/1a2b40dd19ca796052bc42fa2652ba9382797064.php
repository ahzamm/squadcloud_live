...
} elseif ($_instance->childHasBeenRendered('KtZVQV6')) {
    $componentId = $_instance->getRenderedChildComponentId('KtZVQV6');
    $componentTag = $_instance->getRenderedChildComponentTagName('KtZVQV6');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KtZVQV6');
} else {
    $response = \Livewire\Livewire::mount('front.slides');
    $dom = $response->dom;
    $_instance->logRenderedChild('KtZVQV6', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                     </div>
...
} elseif ($_instance->childHasBeenRendered('WtI4EZU')) {
    $componentId = $_instance->getRenderedChildComponentId('WtI4EZU');
    $componentTag = $_instance->getRenderedChildComponentTagName('WtI4EZU');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WtI4EZU');
} else {
    $response = \Livewire\Livewire::mount('front.pakage-detail');
    $dom = $response->dom;
    $_instance->logRenderedChild('WtI4EZU', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
} elseif ($_instance->childHasBeenRendered('kkHTTlh')) {
    $componentId = $_instance->getRenderedChildComponentId('kkHTTlh');
    $componentTag = $_instance->getRenderedChildComponentTagName('kkHTTlh');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kkHTTlh');
} else {
    $response = \Livewire\Livewire::mount('front.reseller-detail');
    $dom = $response->dom;
    $_instance->logRenderedChild('kkHTTlh', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                         </div>
...
} elseif ($_instance->childHasBeenRendered('Oga0Kw8')) {
    $componentId = $_instance->getRenderedChildComponentId('Oga0Kw8');
    $componentTag = $_instance->getRenderedChildComponentTagName('Oga0Kw8');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Oga0Kw8');
} else {
    $response = \Livewire\Livewire::mount('front.about');
    $dom = $response->dom;
    $_instance->logRenderedChild('Oga0Kw8', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
} elseif ($_instance->childHasBeenRendered('5xVLar4')) {
    $componentId = $_instance->getRenderedChildComponentId('5xVLar4');
    $componentTag = $_instance->getRenderedChildComponentTagName('5xVLar4');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5xVLar4');
} else {
    $response = \Livewire\Livewire::mount('front.messages');
    $dom = $response->dom;
    $_instance->logRenderedChild('5xVLar4', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                   <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('JAmSHqc')) {
    $componentId = $_instance->getRenderedChildComponentId('JAmSHqc');
    $componentTag = $_instance->getRenderedChildComponentTagName('JAmSHqc');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JAmSHqc');
} else {
    $response = \Livewire\Livewire::mount('front.why-us-details');
    $dom = $response->dom;
    $_instance->logRenderedChild('JAmSHqc', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                   </div>
...
} elseif ($_instance->childHasBeenRendered('FA0iAVS')) {
    $componentId = $_instance->getRenderedChildComponentId('FA0iAVS');
    $componentTag = $_instance->getRenderedChildComponentTagName('FA0iAVS');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FA0iAVS');
} else {
    $response = \Livewire\Livewire::mount('front.contact');
    $dom = $response->dom;
    $_instance->logRenderedChild('FA0iAVS', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                         </div>
...
} elseif ($_instance->childHasBeenRendered('ieIOc9Z')) {
    $componentId = $_instance->getRenderedChildComponentId('ieIOc9Z');
    $componentTag = $_instance->getRenderedChildComponentTagName('ieIOc9Z');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ieIOc9Z');
} else {
    $response = \Livewire\Livewire::mount('front.faqs');
    $dom = $response->dom;
    $_instance->logRenderedChild('ieIOc9Z', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                           </div>
