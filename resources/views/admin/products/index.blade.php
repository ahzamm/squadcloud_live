        ...
        <div class="col-12">
          <div class="card mt-3 card-outline card-info">
            <div class="card-header">
              <h3 class="card-title"><span><i class="fa-solid fa-box-open"></i></span> Product</h3>
              <a class="btn btn-success btn-sm float-right" href="{{route('products.create')}}"><i class="fa fa-plus"></i> Add Product</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr class="table-row"> 
                      ...
                      <td>
                          <img width="40px" height="40px" src="{{ asset('frontend_assets/images/products/' . $item->image) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                      </td>
                      <td>{{ $item->link}}</td>
                      <td>{{ $item->rating}}</td>
                      ...
                      <td>
                        <img width="40px" height="40px" src="{{ asset('frontend_assets/images/products/' . $item->screenshot_1) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                    </td>
                    <td>
                      <img width="40px" height="40px" src="{{ asset('frontend_assets/images/products/' . $item->screenshot_2) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                  </td>
                  <td>
                    <img width="40px" height="40px" src="{{ asset('frontend_assets/images/products/' . $item->screenshot_3) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                </td>
                  <td>
                    <img width="40px" height="40px" src="{{ asset('frontend_assets/images/products/' . $item->background_image) }}" alt="internet product provider in karachi/Clifton/pakistan" />
                </td>
...
<script>
  let packageDeleteUrl  = "{{route('product.destroy')}}"; 
      ...
      if (result.value) {
       ...
       $.ajax({
        ...
        success:function(res){
          if(res.unauthorized){
            swal('Error!' , 'No Rights To delete Product' , "error");
          }
          if(res.status)
          {
           swal('Updated!', 'Product deleted', 'success');
           location.reload();
