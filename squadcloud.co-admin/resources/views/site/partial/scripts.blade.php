...
// });
  ...
  let partnerUrl  = "{{route('becompartner')}}" ;
  ...
  $(document).on('submit','#frontcontactform',function(e){
    ...
    $.ajax({
      ...
      processData:false,
      beforeSend:function(){
        $('#p-btn').prop('disabled',true).html('<img src="{{asset('site/css/images/spinner.gif')}}" width="30" alt="contact-preloader">');
      },
      success:function(res){
...
<script src="{{asset('site/js/plugins/responsive-lightbox/assets/nivo/nivo-lightbox.min.js')}}"></script>
<script>
  /* <![CDATA[ */
  var rlArgs = {
    script: "nivo",
...
<script src="{{asset('site/js/plugins/responsive-lightbox/js/frontd.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/jquery.themepunch.tools.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.navigation.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.parallax.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.actions.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.video.min.js')}}"></script>
<script src="{{asset('site/js/plugins/revslider/public/assets/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
<script>
  (function ($) {
    $(document).ready(function () {
...
<script src="{{asset('site/js/plugins/js-skin.js')}}"></script>
<script>
...
<script src="{{asset('site/js/plugins/thickbox/thickbox.js')}}"></script>
<script src="{{asset('site/js/plugins/bootstrap.min.js')}}"></script>
<script src="{{asset('site/js/plugins/easing.js')}}"></script>
<script src="{{asset('site/js/plugins/owl-carousel/owl.carousel.min.js')}}"></script>
<script src="{{asset('site/js/plugins/jquery.nanoscroller.min.js')}}"></script>
<script src="{{asset('site/js/plugins/jquery.mixitup.min.js')}}"></script>
<script src="{{asset('site/js/plugins/TweenMax.min.js')}}"></script>
<script src="{{asset('site/js/plugins/template.js')}}"></script>
<script src="{{asset('site/js/plugins/js_composer/assets/js/dist/js_composer_front.min.js')}}"></script>
<script src="{{asset('site/js/plugins/js_composer/assets/lib/waypoints/waypoints.min.js')}}"></script>
<script src="{{asset('site/js/plugins/jquery.appear.js')}}"></script>
<script src="{{asset('site/js/plugins/jquery.countTo.js')}}"></script>
<script src="{{asset('site/js/plugins/js_composer/assets/lib/bower/skrollr/dist/skrollr.min.js')}}"></script>
{{-- <script src="{{asset('site/js/plugins/js_composer/assets/lib/vc_accordion/vc-accordion.min.js')}}"></script>
<script src="{{asset('site/js/plugins/js_composer/assets/lib/vc-tta-autoplay/vc-tta-autoplay.min.js')}}"></script> --}}
<script src="{{asset('site/js/plugins/js_composer/assets/lib/vc_tabs/vc-tabs.min.js')}}"></script>
<script src="{{asset('site/js/plugins/slick.min.js')}}"></script>
{{-- <script src="{{asset('site/js/plugins/quform/js/plugins.js')}}"></script>
<script src="{{asset('site/js/plugins/quform/js/scripts.js')}}"></script> --}}
<script src="{{asset('site/js/modernizr.js')}}"></script>
<script src="{{asset('site/js/jquery.zoomslider.js')}}"></script>
<script>
