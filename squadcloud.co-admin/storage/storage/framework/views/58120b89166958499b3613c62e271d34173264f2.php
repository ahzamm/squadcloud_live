            ...
            <div class="row mt-5 justify-content-center">
              <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="card" style="border-color: rgb(126, 120, 120);">
                  ...
                  <div class="card-body">              
                    <form action="<?php echo e(route('frontmenu.store')); ?>" method="POST" id="AddMenusForm">
                      <?php echo csrf_field(); ?>
                      <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/frontmenu/create.blade.php ENDPATH**/ ?>