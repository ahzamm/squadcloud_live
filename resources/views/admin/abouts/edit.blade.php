      ...
      <div class="col-md-12">
        <div class="card card-outline card-info">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0"><span><i class="fa-solid fa-box-open"></i></span> Edit About</h3>
            <!-- <div class="ml-auto">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    width="120" alt="" srcset="" style="background-color: rgba(0, 0, 0, 0.5); padding: 10px; display: inline-block;">
                    @endisset
                    <br><br>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control summernote" name="description_1"  rows="4">{{$about->description_1}}</textarea>
                    @error('description_1')
                    <p class="text-danger mt-2 mb-0 text-sm">{{$message}}</p>
                    @enderror
                  </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control summernote" name="description_2"  rows="4">{{$about->description_2}}</textarea>
                    @error('description_2')
                    <p class="text-danger mt-2 mb-0 text-sm">{{$message}}</p>
                    @enderror
                  </div>
                ...
                <div class="col-md-13">
                  <div class="form-group">
                    ...
                    <textarea class="form-control summernote" name="description_3"  rows="4">{{$about->description_3}}</textarea>
                    @error('description_3')
                    <p class="text-danger mt-2 mb-0 text-sm">{{$message}}</p>
                    @enderror
                  </div>
