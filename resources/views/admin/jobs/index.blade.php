                    ...
                    <div class="col-12">
                        <div class="card mt-3 card-outline card-info">
                            <div class="card-header">
                                ...
                                <a class="btn btn-success btn-sm float-right" href="{{ route('jobs.create') }}"><i
                                        class="fa fa-plus"></i> Add Vacancy</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody id="sortfrontMenu" class="move">
                                            @foreach ($jobs as $key => $item)
                                                <tr class="table-row">
                                                    ...
                                                    <td>{{ $key + 1 }}<input type="hidden"
                                                            class="order-id"value="{{ $item->id }}"></td>
