                  ...
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                           <div class="ml-auto">
                              <a href="<?php echo e(route('menus.create')); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Admin Menus / SubMenus</a>
                           </div>
                        </div>
                        <div class="card-body">
                           <div class="table-responsive scrol">
                              <table id="example" style="width: 100%;" class="table table-bordered table-striped">
                                 ...
                                 <tbody id="sortMenuTable" class="move">
                                    ...
                                    <tr>
                                       <td><?php echo e($key+1); ?> <input type="hidden" class="order-id" value="<?php echo e($menu->id); ?>"></td>
                                       <td><?php echo e($menu->menu); ?></td>
                                       <td><?php echo e($menu->submenus->count()); ?></td>
                                       <td>
                                          <a href="<?php echo e(route("menu.edit",$menu->id)); ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                          <button class="btn btn-sm btn-danger btnDeleteMenu" data-value="<?php echo e($menu->id); ?>"><i class="fa fa-trash"></i></button>
                                       </td>
                                    </tr>
...
<script>
   ...
   $(document).on('click', '#SortMenu', function() {
      ...
      $.ajax({
         url: "<?php echo e(route('menus.sort')); ?>",
         method: 'get',
         dataType: 'html',
         beforeSend: function() {
   ...
   //  Sorting Sliders
   let sortMenuUrl = "<?php echo e(route('sort.menu')); ?>";
   let sortTable = $("#sortMenuTable");
   let csrfToken = $('.csrf_token')
   let editUrlFront = "<?php echo e(route('menu.edit')); ?>";
   $(sortTable).sortable({
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/blinkbroadband.pk/resources/views/admin/backmenu/index.blade.php ENDPATH**/ ?>