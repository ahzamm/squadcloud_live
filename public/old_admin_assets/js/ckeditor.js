...
*/
    ...
    CKEDITOR.config.magicline_keystrokeNext = CKEDITOR.CTRL + CKEDITOR.SHIFT + 52; (function () {
        function m(a) { if (!a || a.type != CKEDITOR.NODE_ELEMENT || "form" != a.getName()) return []; for (var e = [], c = ["style", "className"], b = 0; b < c.length; b++) { var d = a.$.elements.namedItem(c[b]); d && (d = new CKEDITOR.dom.element(d), e.push([d, d.nextSibling]), d.remove()) } return e } function r(a, e) { if (a && a.type == CKEDITOR.NODE_ELEMENT && "form" == a.getName() && 0 < e.length) for (var c = e.length - 1; 0 <= c; c--) { var b = e[c][0], d = e[c][1]; d ? b.insertBefore(d) : b.appendTo(a) } } function q(a, e) {
            var c = m(a), b = {}, d = a.$; e || (b["class"] = d.className ||
                "", d.className = ""); b.inline = d.style.cssText || ""; e || (d.style.cssText = "position: static; overflow: visible"); r(c); return b
        } function t(a, e) { var c = m(a), b = a.$; "class" in e && (b.className = e["class"]); "inline" in e && (b.style.cssText = e.inline); r(c) } function u(a) {
            if (!a.editable().isInline()) {
                var e = CKEDITOR.instances, c; for (c in e) { var b = e[c]; "wysiwyg" != b.mode || b.readOnly || (b = b.document.getBody(), b.setAttribute("contentEditable", !1), b.setAttribute("contentEditable", !0)) } a.editable().hasFocus && (a.toolbox.focus(),
                    a.focus())
            }
        } CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                function e() { var b = d.getViewPaneSize(); a.resize(b.width, b.height, null, !0) } if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    var c = a.lang, b = CKEDITOR.document, d = b.getWindow(), k, l, n, m = CKEDITOR.TRISTATE_OFF; a.addCommand("maximize", {
                        modes: { wysiwyg: !CKEDITOR.env.iOS, source: !CKEDITOR.env.iOS }, readOnly: 1, editorFocus: !1, exec: function () {
                            var g = a.container.getFirst(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }), c = a.ui.space("contents");
                            if ("wysiwyg" == a.mode) { var f = a.getSelection(); k = f && f.getRanges(); l = d.getScrollPosition() } else { var h = a.editable().$; k = !CKEDITOR.env.ie && [h.selectionStart, h.selectionEnd]; l = [h.scrollLeft, h.scrollTop] } if (this.state == CKEDITOR.TRISTATE_OFF) {
                                d.on("resize", e); n = d.getScrollPosition(); for (f = a.container; f = f.getParent();)f.setCustomData("maximize_saved_styles", q(f)), f.setStyle("z-index", a.config.baseFloatZIndex - 5); c.setCustomData("maximize_saved_styles", q(c, !0)); g.setCustomData("maximize_saved_styles", q(g, !0));
                            ...
                            } this.toggleState(); "wysiwyg" == a.mode ? k ? (CKEDITOR.env.gecko && u(a), a.getSelection().selectRanges(k), (h = a.getSelection().getStartElement()) && h.scrollIntoView(!0)) : d.$.scrollTo(l.x, l.y) : (k && (h.selectionStart = k[0], h.selectionEnd = k[1]),
                                h.scrollLeft = l[0], h.scrollTop = l[1]); k = l = null; m = this.state; a.fire("maximize", this.state)
                        }, canUndo: !1
    ...
    CKEDITOR.config.tabletools_scopedHeaders = !1; (function () {
        ...
        CKEDITOR.plugins.add("uploadwidget", { requires: "widget,clipboard,filetools,notificationaggregator", init: function (a) { a.filter.allow("*[!data-widget,!data-cke-upload-id]") }, isSupportedEnvironment: function () { return CKEDITOR.plugins.clipboard.isFileApiSupported } }); CKEDITOR.fileTools || (CKEDITOR.fileTools = {}); CKEDITOR.tools.extend(CKEDITOR.fileTools, {
            addUploadWidget: function (a, c, e) {
                    ...
                    function (a) { return e.supportedTypes ? g.isTypeSupported(a, e.supportedTypes) : !0 }); if (e.fileToElement) a.on("paste", function (d) {
                        ...
                        downcast: function () { return new CKEDITOR.htmlParser.text("") }, init: function () {
                            ...
                            if ("" === d.trim()) a.widgets.del(this); else {
                                ...
                                h = a.createRange(), f, g; b || (g = a.getSelection().createBookmarks()); h.setStartBefore(this.wrapper); h.setEndAfter(this.wrapper); b && (f = h.createBookmark()); e.insertHtmlIntoRange(d, h, c); a.widgets.checkWidgets({ initOnlyNew: !0 }); a.widgets.destroy(this, !0); b ? (h.moveToBookmark(f), h.select()) : a.getSelection().selectBookmarks(g)
                            }
                ...
                c, e) { a.setAttributes({ "data-cke-upload-id": e, "data-widget": c }) }, bindNotifications: function (a, c) {
                    function e() {
                ...
                if (this.isSupportedEnvironment()) {
                    var b =
                        CKEDITOR.fileTools, d = b.getUploadUrl(a.config, "image"); d && (a.config.clipboard_handleImages && (a.config.clipboard_handleImages = !1, CKEDITOR.warn("clipboard-image-handling-disabled", { editor: a.name, plugin: "uploadimage" })), b.addUploadWidget(a, "uploadimage", {
                            supportedTypes: /image\/(jpeg|png|gif|bmp)/, uploadUrl: d, fileToElement: function () { var a = new CKEDITOR.dom.element("img"); a.setAttribute("src", "data:image/gif;base64,R0lGODlhDgAOAIAAAAAAAP///yH5BAAAAAAALAAAAAAOAA4AAAIMhI+py+0Po5y02qsKADs\x3d"); return a },
